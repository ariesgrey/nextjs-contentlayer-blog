			...
			<div className="w-full absolute bottom-0 p-4 xs:p-6 sm:p-10 z-20">
				...
				<Link href={blog.url} className="mt-6">
					<h2 className="font-bold capitalize text-light text-sm xs:text-base sm:text-xl md:text-2xl mt-2 sm:mt-4">
						<span className="bg-gradient-to-r from-accent/75 to-accent/75 dark:from-accentDark/50 dark:to-accentDark/50 bg-[length:0px_6px] group-hover:bg-[length:100%_6px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500">
							{blog.title}
						</span>
					</h2>
				</Link>
